...
<body>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="../public/admin/images/dashboard/people.svg" alt="people">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        <img src="../public/admin/images/faces/face1.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="../public/admin/images/faces/face2.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                      <img src="../public/admin/images/faces/face3.jpg" alt="user">
                     <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="../public/admin/images/faces/face4.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="../public/admin/images/faces/face5.jpg" alt="user">
                        <div>
  ...
  <script src="../public/admin/vendors/datatables.net/jquery.dataTables.js"></script>
  <script src="../public/admin/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
  <script src="../public/admin/js/dataTables.select.min.js"></script>
